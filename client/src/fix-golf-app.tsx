      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ backgroundColor: 'white', padding: '40px', borderRadius: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
            <div style={{ border: '1px solid #e2e8f0', borderRadius: '8px', padding: '20px', textAlign: 'center' }}>
              <h3 style={{ fontSize: '20px', color: '#1e293b', marginBottom: '10px' }}>Classic Green</h3>
              <p style={{ color: '#64748b', marginBottom: '20px' }}>Traditional & Elegant</p>
              <a
            ...
            <div style={{ border: '1px solid #e2e8f0', borderRadius: '8px', padding: '20px', textAlign: 'center' }}>
              <h3 style={{ fontSize: '20px', color: '#1e293b', marginBottom: '10px' }}>Ocean Blue</h3>
              <p style={{ color: '#64748b', marginBottom: '20px' }}>Modern & Contemporary</p>
              <a
            ...
            <div style={{ border: '1px solid #e2e8f0', borderRadius: '8px', padding: '20px', textAlign: 'center' }}>
              <h3 style={{ fontSize: '20px', color: '#1e293b', marginBottom: '10px' }}>Autumn Gold</h3>
              <p style={{ color: '#64748b', marginBottom: '20px' }}>Warm & Inviting</p>
              <a
            ...
            <div style={{ border: '1px solid #e2e8f0', borderRadius: '8px', padding: '20px', textAlign: 'center' }}>
              <h3 style={{ fontSize: '20px', color: '#1e293b', marginBottom: '10px' }}>Royal Purple</h3>
              <p style={{ color: '#64748b', marginBottom: '20px' }}>Premium & Sophisticated</p>
              <a
...
export default function FixGolfApp() {
